...
export class LiquidityMapService {
  ...
  private analyzeOrderbook(
    ...
    // Binance depth updates arrive unsorted — must sort for correct local/wall analysis
  ...
  private resolveMid(orderbook: OrderBook): number {
    // Binance depth updates are NOT sorted — find actual best bid (max) and ask (min)
    let bestBid = 0;
