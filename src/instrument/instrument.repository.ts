...
export class InstrumentRepository {
  constructor(
    ...
    private readonly events: InstrumentEventAdapter,
  ...
  async deleteAll(connectorType: string, marketType: string): Promise<void> {
    ...
    InstrumentRepository.deleteLock = InstrumentRepository.deleteLock.then(async () => {
    ...
    return InstrumentRepository.deleteLock;
  }
  ...
  //  */
  // async insert(instrument: InstrumentEntity): Promise<void> {
  ...
  async insertMany(
    ...
    const entities: InstrumentEntity[] = [];
