...
export abstract class BaseRepository<T = any> {
  protected channel: 'main' | 'trades' | 'candles' | 'orderbook' | 'events' =
    'main';
  ...
  constructor(
    ...
    protected readonly reader: QuestDBQueryService, // protected readonly channel: 'main' | 'trades' | 'candles' | 'orderbook' | 'events' = 'main',
  ) {}
